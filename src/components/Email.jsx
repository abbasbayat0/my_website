    ...
    return (
        <div className='absolute md:left-5 top-[90%] md:top-[130%] xl:top-64 w-full xl:w-1/2 h-4/6 font-poppins'>
                ...
                <form className='absolute w-full h-full z-10 flex flex-col' ref={form} onSubmit={sendEmail}>
                    ...
                    <input required type="email" placeholder='email' name="user_email" className='w-72 bg-gray-700 p-2 rounded-lg absolute lg:ml-44 lg:w-1/3 md:left-96 text-gray-200 xl:left-80 left-20 xl:mt-0 focus:outline-none xl:w-1/3 xl:' />
