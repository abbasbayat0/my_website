    ...
    return (
        <div>
            ...
            <div className="lg:w-3/4 lg:h-3/4 w-full h-2/3 top-44 right-2 absolute lg:top-1/4 lg:left-[130px]">
                <img src={require("../images/pouria.JPG")} alt="pouriamaleki.com" className="rounded-lg w-full opacity-90 animate-image " />
            ...
            <div className="lg:w-3/4 lg:h-3/4 w-full h-1/3 absolute top-[70%] right-2 lg:top-[100%] lg:left-[130px] xl:top-[150%]">
                <img src={require("../images/todo.JPG")} alt="todo list" className="rounded-lg w-full opacity-90 animate-image " />
                <div className="animate-description lg:h-72 bg-gray-700 opacity-80 rounded-xl absolute top-38 lg:right-0 lg:bottom-30 flex justify-center items-center flex-col xl:w-2/5 xl:top-[70%]">
