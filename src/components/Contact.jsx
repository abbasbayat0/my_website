...
const Contact = () => {
    ...
    return (
        <div className="w-full h-full absolute flex z-10 justify-center items-center overflow-x-hidden">
            ...
            {/* info */}
            <div className='absolute right-20 top-44 w-1/3 h-5/6'>

                {/* the icons */}
                <div className='z-10 flex flex-col items-center justify-around w-20 h-4/5 absolute left-24 top-10'>
                ...
                {/* the titles */}
                <div className='z-10 flex flex-col items-start justify-around w-20 h-4/5 absolute left-40 top-7'>
                ...
                {/* the main */}
                <div className='z-10 flex flex-col items-start opacity-60 justify-around w-56 h-4/5 absolute left-40 top-14'>
