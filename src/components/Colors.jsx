...
const Color = () => {
    ...
    return (
        <div className="absolute right-1 top-1/3 z-20 flex w-56 h-52 p-2 overflow-hidden">
            <div>
                <i class={`fa-solid fa-gear animate-gear ${state.showColor? "translate-x-0 opacity-90": "translate-x-[185px] opacity-70"} cursor-pointer mr-2 text-sand-50 text-2xl transition-all duration-1000`}
