    ...
    return (
        <div className="w-full h-full absolute flex justify-center items-center overflow-x-hidden z-10">
            ...
            {state.color === "jade-600" && 
                <img src={require("../images/jade-600.png")} alt="" className='opacity-70 absolute top-1/4 right-10' />
            }
            {state.color === "cardinal-700" && 
                <img src={require("../images/cardinal-700.png")} alt="" className='opacity-70 absolute top-1/4 right-10' />
            }
            {state.color === "chill-700" && 
                <img src={require("../images/chill-700.png")} alt="" className='opacity-70 absolute top-1/4 right-10' />
            }
            {state.color === "sienna-500" && 
                <img src={require("../images/sienna-500.png")} alt="" className='opacity-70 absolute top-1/4 right-10' />
            }
            {state.color === "indigo-900" && 
                <img src={require("../images/indigo-900.png")} alt="" className='opacity-70 absolute top-1/4 right-10' />
            }
            {state.color === "endeavour-700" && 
                <img src={require("../images/endeavour-700.png")} alt="" className='opacity-70 absolute top-1/4 right-10' />
            }
            
            <div className='w-1/2 h-80 absolute left-24 top-56'>
                <p className='text-sand-50 font-poppins text-4xl'>I'm a Creative <span className={`${state.text}`}>Front-end</span> Developer</p>
                <p className='text-sand-50 font-poppins absolute top-16 text-justify opacity-80 z-10'>I am a front-end developer with a strong passion for web development. I am constantly seeking out opportunities to expand my knowledge and skills in this ever-evolving field. I am particularly interested in exploring new technologies and incorporating them into my work to create innovative and user-friendly websites. I am also enthusiastic about collaborating with other professionals in the industry and am eager to gain experience working in a team of skilled programmers. While I have primarily worked independently thus far, I am excited about the prospect of contributing to and learning from a collaborative team environment.</p>
            </div>

            {/* skills */}
            <p className='text-sand-50 absolute top-full text-5xl font-raleway font-bold'>My <span className={`${state.text}`}>Skills</span></p>

            <div className='w-full absolute top-[110%] flex items-center justify-center flex-wrap'>

                {/* html */}
                <div title='HTML' className='w-1/4 h-52 overflow-hidden relative bg-gray-900 opacity-90 m-5 rounded-2xl flex justify-center items-center'
                ...
                {/* css */}
                <div title='CSS' className='w-1/4 h-52 overflow-hidden relative bg-gray-900 opacity-90 m-5 rounded-2xl flex justify-center items-center'
                ...
                {/* js */}
                <div title='JavaScript' className='w-1/4 h-52 overflow-hidden relative bg-gray-900 opacity-90 m-5 rounded-2xl flex justify-center items-center'
                ...
                {/* react */}
                <div title='React' className='w-1/4 h-52 overflow-hidden relative bg-gray-900 opacity-90 m-5 rounded-2xl flex justify-center items-center'
                ...
                {/* npm */}
                <div title='Node Package Manager' className='w-1/4 h-52 overflow-hidden relative bg-gray-900 opacity-90 m-5 rounded-2xl flex justify-center items-center'
                ...
                {/* git */}
                <div title='Git & GitHub' className='w-1/4 h-52 overflow-hidden relative bg-gray-900 opacity-90 m-5 rounded-2xl flex justify-center items-center'
                ...
                {/* tailwind */}
                <div title='TailwindCSS' className='w-1/4 h-52 overflow-hidden relative bg-gray-900 opacity-90 m-5 rounded-2xl flex justify-center items-center'
