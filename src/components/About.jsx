...
const about = () => {
  ...
  return (
    <div className="w-full h-full absolute flex justify-center items-center overflow-x-hidden z-10">
      <p className="text-sand-50 absolute top-20 text-5xl font-raleway font-bold">
        About <span className={`${state.text} leading-3`}>Me</span>
      </p>
      <p className="text-sand-50 text-xl font-raleway absolute top-32 opacity-80">
        Get to Know <span className={`${state.text}`}>me.</span>
      </p>
      ...
      <div className="lg:w-1/2 w-full h-80 absolute md:mt-10 lg:left-10 p-5 lg:p-0 lg:top-56 top-[60%]">
        ...
        <p className="text-sand-50 w-11/12 ??? font-poppins absolute lg:top-16 top-40 text-justify opacity-80 md:top-24 z-10">
          ...
          exploring new technologies and incorporating them into my work to
          create innovative and user-friendly websites. I am also enthusiastic
          about collaborating with other professionals in the industry and am
          eager to gain experience working in a team of skilled programmers.
          While I have primarily worked independently thus far, I am excited
          about the prospect of contributing to and learning from a
      ...
      <div className="w-full absolute lg:top-[80%] xl:top-[110%] top-[130%] flex items-center justify-center flex-wrap md:top-[110%]">
        ...
        <div
          title="HTML"
          className="lg:w-1/4 lg:h-52 h-20 w-1/5 overflow-hidden relative bg-gray-900 opacity-90 m-5 rounded-2xl flex justify-center items-center"
        ...
        >
          ...
          <div
            className={`${
              state.hover1 ? "w-full h-96" : "w-24"
            } rounded-3xl h-20 bg-${
              state.color
            } absolute opacity-50 transition-all duration-900`}
          ></div>
        </div>
