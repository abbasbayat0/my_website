const Social = () => {
  return (
    <div className="w-full h-52 z-10 absolute bottom-0 flex justify-center items-center lg:flex-col lg:left-10 xl:top-1/3 lg:top-1/2 lg:w-20 lg:justify-center md:flex-col md:left-10 md:top-1/2 md:w-20 md:justify-center">
      <a
        href="https://www.linkedin.com/in/abbasbayat/"
        className="p-6 lg:p-0"
        target="_blank"
        rel="noreferrer"
      >
        <i
          className="fa-brands fa-linkedin transition-all duration-300 opacity-70 text-sand-50 text-3xl cursor-pointer md:text-5xl lg:text-5xl lg:mt-5 xl:text-3xl"
          onMouseEnter={(e) => {
      ...
      >
        <i
          className="fa-brands fa-github transition-all duration-300 opacity-70 text-sand-50 text-3xl cursor-pointer md:text-5xl lg:text-5xl lg:mt-5 xl:text-3xl"
          onMouseEnter={(e) => {
            e.target.classList.replace("opacity-70", "opacity-100");
      ...
      >
        <i
          className="fa-brands fa-telegram transition-all duration-300 opacity-70 text-sand-50 text-3xl cursor-pointer md:text-5xl lg:text-5xl lg:mt-5 xl:text-3xl"
          onMouseEnter={(e) => {
            e.target.classList.replace("opacity-70", "opacity-100");
      ...
      <a
        href="https://www.instagram.com/abbasbayat0/"
        className="p-6 lg:p-0"
        target="_blank"
        rel="noreferrer"
      >
        <i
          className="fa-brands fa-instagram transition-all duration-300 opacity-70 text-sand-50 text-3xl cursor-pointer md:text-5xl lg:text-5xl lg:mt-5 xl:text-3xl"
          onMouseEnter={(e) => {
            e.target.classList.replace("opacity-70", "opacity-100");
